    ...
    <section>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="data-field">
                ...
                <input id="name" type="text" name="name" maxlength="50" value="<?= $user['name'] ?>"/>
                <span class="errors"><?= isset($errors['name']) ? $errors['name'] : '' ?></span>
            </div>
            <div class="data-field">
                <label for="email">E-Mail</label>
                <input id="email" type="email" name="email" maxlength="50" value="<?= $user['email'] ?>"/>
            ...
            <div class="data-field">
                ...
                <input id="adress" type="text" name="adress" maxlength="60" value="<?= $user['adress'] ?>"/>
